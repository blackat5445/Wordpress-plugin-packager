...
echo EXCLUDE_LIST=.git,.svn,node_modules,dist,Compiler.bat,packager.config>> "%CONFIG_FILE%"
...
echo =========================================================
echo.
echo Current exclusions: .git, .svn, node_modules, dist, Compiler.bat, packager.config
echo.
...
if "%MENU_CHOICE%"=="3" goto END_SCRIPT
